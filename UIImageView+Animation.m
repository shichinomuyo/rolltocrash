...
- (void)crashUIImageViewAnimation{
    ...
    [self setImage:[UIImage imageNamed:@"ctrlBtnCrash11.png"]];
    [self setHidden:0];
    [self setAlpha:0.7];
                                                                                                                              ...
                                                                                                                              animations:^{// タメ
                                                                                                                                  ...
                                                                                                                                  [UIView animateWithDuration:0.1f
                                                                                                                                                   ...
                                                                                                                                                   animations:^{ // 小さくなる
                                                                                                                                                       ...
                                                                                                                                                       [self setImage:[UIImage imageNamed:@"ctrlBtnCrash2.png"]];
                                                                                                                                                       ...
                                                                                                                                                       [UIView animateWithDuration:0.1f
                                                                                                                                                                        ...
                                                                                                                                                                        animations:^{ // 丸に戻りかけ
                                                                                                                                                                            //                                                                                                                                                       self.transform =  CGAffineTransformConcat(self.transform, concat);
                                                                                                                                                                            [self setImage:[UIImage imageNamed:@"ctrlBtnCrash3.png"]];
                                                                                                                                                                            ...
                                                                                                                                                                            [UIView animateWithDuration:0.1f
                                                                                                                                                                                             ...
                                                                                                                                                                                             animations:^{ // エメラルド丸に戻る
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 [self setImage:[UIImage imageNamed:@"ctrlBtnDefault09.png"]];
...
- (void)appearALIZARINWithScaleUp:(NSTimer *)timer{
    self.transform = CGAffineTransformIdentity;
    [self setImage:[UIImage imageNamed:@"hit_R1099.png"]];
    [self setHidden:0];
