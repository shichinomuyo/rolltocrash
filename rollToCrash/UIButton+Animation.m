...
- (void)ctrlBtnFirstAppearWithScaleUpSetEnable{
    ...
    CGAffineTransform t1 = CGAffineTransformMakeScale(scale, scale); // 拡大
    
    self.transform = CGAffineTransformMakeScale(0.1, 0.1);
    [self setImage:[UIImage imageNamed:@"EMERALD09.png"] forState:UIControlStateNormal];
                                                               ...
                                                               animations:^{
                                                                   ...
                                                                   [UIView animateWithDuration:0.1f
                                                                                    ...
                                                                                    animations:^{
                                                                                        ...
                                                                                        [UIView animateWithDuration:0.1f // playmarkerのアニメーション完了待ちも兼ねてタメ
                                                                                                              delay:0.0f
                                                                                                            options:UIViewAnimationOptionCurveEaseOut |UIViewAnimationOptionBeginFromCurrentState
                                                                                                         animations:^{
                                                                                                             ...
                                                                                                             [UIView animateWithDuration:0.1f
                                                                                                                              ...
                                                                                                                              animations:^{
                                                                                                                                  ...
                                                                                                                                  self.transform = CGAffineTransformIdentity;
                                                                                                                                  [self setImage:[UIImage imageNamed:@"ctrlBtnDefault09.png"] forState:UIControlStateNormal];
                                                                                                                                  [self setEnabled:1];
